...
const WhyDataScience = () => {
   ...
   const service = [
        { 
            ...
            color: "#e67e22", 
            desc: "Work on real datasets and solve real-world business problems." 
        },
        { 
            icon: CastForEducationIcon, 
            label: "Expert Trainers", 
            color: "#00b83d", 
            desc:"Learn from data professionals with years of industry experience." 
        },
        { 
            icon: CrisisAlertIcon, 
            label: "Placement Focused", 
            color: "#1976d2" , 
            desc:"Dedicated placement cell for resume, mock interviews & referrals."
        },
        { 
            icon: AccessTimeIcon, 
        ...
        { 
            ...
            label: "Certification", 
            color: "#e91e63" , 
            desc:"Industry recognized certification to boost your career."
        },
        { 
            icon: HeadsetMicIcon, 
