                    ...
                    <Box sx={{height:"100%",display:"flex",flexDirection:"column", bgcolor:'rgba(4, 11, 43, 0.99)',}}>
                        <Box sx={{display:"flex",flexDirection:"column",justifyContent:"space-evenly",flexGrow:1,p:{xs:2,lg:1},pl:{xs:2,lg:6},gap:{xs:2,lg:0}}}>
                            <Box sx={{display:"flex",flexDirection:"column",gap:2}}>
                                ...
                                Data Science Course <Box component='span' sx={{color:'#f6f605'}}> in Coimbatore</Box></Typography>
                                <Typography sx={{color:'white', fontSize:'2rem' }} >Learn Data. Analyze Data. Build Your Future.</Typography>
                           <Typography sx={{color:'#d9d4d4', lineHeight:'1.8rem', fontSize:18 }} >Kitkat Software Technologies provides industry-focused data science <br />
                            training that turns beginners into job-ready data professionals with <br /> real-world projects and 100% placement support.</Typography>
                            </Box>
