...
import DataScienceSyllabusTable from './DataScienceSyllabusTable';


const DataSciemceTableDetails = () => {
    const serviceArray = [
        {
                    ...
                    <Grid container sx={{height:"100%", border:'1px solid #c8c6c6', p:2, borderRadius:2}}>
                        ...
                        <Box sx={{display:'flex', justifyContent:'center', width:'100%'}}>
                            <Typography sx={{fontSize:'1.4rem', color:'#071B52', textTransform:'uppercase', fontWeight:800, 
                               ...
                               DATA SCIENCE COURSE SYLLABUS – 7 STAGE LEARNING PATH </Typography>
                        </Box>

                     <DataScienceSyllabusTable/>
...
export default DataSciemceTableDetails;
