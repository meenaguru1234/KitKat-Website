...
import DigitalSyllabusTable from './DigitalSyllabusTable';


const TableDigiDetails = () => {
    const serviceArray = [
        {
                    ...
                    <Grid container sx={{height:"100%", border:'1px solid #c8c6c6', p:2, borderRadius:2}}>
                        ...
                        <Box>
                            <Typography sx={{fontSize:'1.4rem', color:'#071B52', textTransform:'uppercase', fontWeight:800,  }}>
                              Digital Marketing Course Syllabus – 8 Powerful Modules
                                </Typography>
                        </Box>

                     <DigitalSyllabusTable/>
...
export default TableDigiDetails;
