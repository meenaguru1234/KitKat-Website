...
import heropageimg from "../../../assets/Images/product/ecommerce/heropageimg.jpg";
            ...
            <Grid container>
                        ...
                        <Box sx={{display:"flex",flexDirection:"column",justifyContent:"space-around",flexGrow:1,p:{xs:2,lg:1},pl:{xs:2,lg:6},gap:{xs:2,lg:0}}}>
                            <Box sx={{display:"flex",flexDirection:"column",gap:2}}>
                                <Typography component={'h1'} variant="h3" sx={{fontSize:{lg:"2.8rem"},fontWeight:"600", color:'#071B52', }}>
                                   Ecommerce Website Development Company in <Box component={'span'} sx={{color:'#fc8804'}}>Coimbatore</Box></Typography>
                                <Typography sx={{color:'#041b59' , fontSize:17.5}} >
                                    We build high-performing online stores that convert <br /> visitors into loyal customers and scale your business  <br />
                                    from first order to a thousandth.</Typography>
                            </Box>
                                        ...
                                        return (
                                            <Grid size={{xs:item.xs,lg:item.nd}} sx={{display:"flex"}}>
                                                <Box sx={{width:{},display:"flex",gap:1,alignItems:"center",px:{sm:1.5,md:0}}}>
                                                    <Icon sx={{fontSize:{xs:"1rem",sm:"1.5rem",lg:"1.7rem"}, color:'#071B52'}}/>
                                                    <Box sx={{display:"flex",flexDirection:"column"}}>
                                                        <Typography sx={{fontSize:{xs:"0.55rem",sm:"0.9rem",lg:"0.8rem"}, color:'#071B52'}}>{item.number}</Typography>
                            ...
                            <Box sx={{display:"flex",gap:3, mt:0}}>
                                <CommonButton endIcon={<EastOutlinedIcon/>}  sx={{fontSize:"0.9rem", bgcolor:'#fc8804', color:'white', fontWeight:550, width:'320px'}}>Get a Free Ecommerce Consultation</CommonButton>
                ...
                <Grid size={{ xs: 12, md: 7 }}>
                    <Box sx={{position: "relative",width: "auto",height: 500}}>
                        <Box component="img" src={heropageimg} sx={{objectFit: "fill",width: "100%",height: "100%", display:'block', overflow:'hidden',
                            }}/>
