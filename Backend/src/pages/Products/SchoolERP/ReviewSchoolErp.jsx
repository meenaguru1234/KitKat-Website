...
import Logo1 from "../../../assets/Images/product/schoolerp/psg.jpg"
import Logo2 from "../../../assets/Images/product/schoolerp/narayana.png"
import Logo3 from "../../../assets/Images/product/schoolerp/velammal.png"
import Logo4 from "../../../assets/Images/product/schoolerp/ssvm.png"
import Logo5 from "../../../assets/Images/product/schoolerp/sriramakrishna.png"
import Logo6 from "../../../assets/Images/product/hrm/manymore.png"
import Vijay from "../../../assets/Images/Vijay.jpg"
import { CommonButton } from '../../../StyledComponents/CommonButton';

const ReviewSchoolErp = () => {
...
const reviewData = [
        {
            id: 1,
            name: "Rev. Fr. Joseph,",
            company: "Principal, St. Mary's Matric Hr. Sec. School",
            review:
            "Kitkat School ERP has completely changed the way we manage our school. Fee collection improved by 45% and communication with parents is now effortless.",
            image: Vijay,
        },
            ...
            {[...Array(5)].map((_, i) => (
              <FaStar key={i} size={20} color="#FDB022" />
                ...
                <Grid size={{xs:12,sm:8,lg:5}} sx={{display:"flex",flexDirection:"column"}}>
                    <Box sx={{display:"flex",flexDirection:"column",alignItems:"center"}}>
                        <Typography sx={{fontWeight:800, color:'#071B52', fontSize:'20px'}}>Our Happy Clients</Typography>
                    </Box>
                    <Grid container spacing={2} sx={{px:5,height:"50%",mt:4}}>
                        {
                            logoArray.map((item,index) => {
                                return (
                                    <Grid size={4} key={index} sx={{display:"flex",alignItems:"center",height:"35%",border:"1px solid #EBF0F3",borderRadius:3,p:1}}>
...
export default ReviewSchoolErp;