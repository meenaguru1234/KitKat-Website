      ...
      const processSteps = [
            {
              ...
              bgcolor:false,
                 ...
                 desc:"Understand your process & requirements"
            },
            {
                number:'2',
              ...
              bgcolor:false,
                  ...
                  desc:"Create solution blueprint & technical roadmap."
            },
            {          
              number:'3',
            ...
            desc:"Rigorous testing for accuracy & security."
            },
             {
          number:'5',
          ...
          bgcolor:true,
          title: "Deployment",
          desc: "Smooth deployment with data migration."
        },
            {
              number:'6',
          ...
          bgcolor:true,
          title: "Support",
          desc: "Ongoing maintenance & continuous support."
        },
 ...
 <Grid container sx={{ mx:'auto', width:1300}}>
  ...
  <Grid size={{xs:12,sm:12,}} sx={{border:"1px solid #E5E7EB",borderRadius:5, }}>
                   ...
                   <Box sx={{justifyContent:'left',mb:3 }}>
                            <Typography sx={{fontSize:'1.5rem', fontWeight:600, color:'#08044f'}}>Our Gold Loan Software Development Process</Typography>
...
export default ProcessGoldloan