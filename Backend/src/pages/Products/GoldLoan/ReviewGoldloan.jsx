...
import Logo1 from '../../../assets/Images/product/goldloan/manapuram.jpg'
import Logo2 from "../../../assets/Images/product/goldloan/muthoot.png"
import Logo3 from "../../../assets/Images/product/goldloan/iifl.png"
import Logo4 from "../../../assets/Images/product/goldloan/indostar.png"
import Logo5 from "../../../assets/Images/product/goldloan/bhima.png"
import Logo6 from "../../../assets/Images/product/hrm/manymore.png"
import Vijay from "../../../assets/Images/Vijay.jpg"
import { CommonButton } from '../../../StyledComponents/CommonButton';

const ReviewGoldloan = () => {
...
const reviewData = [
        {
            id: 1,
            name: "Karthik S.",
            company: "Managing Director, Sri Lakshmi Finance",
            review:
            "Kitkat Gold Loan Software streamlined our operations. Loan processing time reduced by 60% and recovery improved significantly.",
            image: Vijay,
        },
           {
            id: 2,
                                            ...
                                            <SwiperSlide key={index}>
                                                <Card sx={{border:"2px solid #EBF0F3",boxShadow:"0",borderRadius:4}}>
                                                    <CardContent sx={{display:"flex",flexDirection:"column"}}>
                                                        <Typography sx={{color:"blue", fontSize:'40px'}}>
                                                            ❝
                                                        </Typography>
