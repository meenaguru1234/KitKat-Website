    ...
    <Box sx={{ bgcolor: "#071f3b", color: "#fff", py: 2 , width:'100%', borderRadius:'0px', marginLeft:'0%', mb:-4}}>
      <Grid container alignItems="center">
        ...
        <Grid size={{ xs: 12, md:6}}>
          ...
          >
            <Typography sx={{fontSize:24, fontWeight:600}}>Ready to Automate Your HR Operations?</Typography>
            <Typography sx={{fontSize:16,fontWeight:500}}>Join 300+ businesses that trust Kitkat for their HRM software needs.</Typography>
