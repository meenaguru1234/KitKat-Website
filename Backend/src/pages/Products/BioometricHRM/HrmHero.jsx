...
import hrmheroimg from "../../../assets/Images/product/hrm/hrmheroimg.png";
            ...
            <Grid container >
                    ...
                    <Box sx={{height:"100%",display:"flex",flexDirection:"column", p:1,}}>
                        <Box sx={{display:"flex",flexDirection:"column",justifyContent:"space-evenly",flexGrow:1,pl:{xs:2,lg:4},p:{xs:2,lg:1},gap:{xs:2,lg:0}}}>
                            <Box sx={{display:"flex",flexDirection:"column",gap:2, p:2}}>
                                <Typography component={'h1'} variant="h3" sx={{fontSize:{lg:"2.5rem"},fontWeight:"600", color:'#071B52'}}>HRM Software Development Company Building  Smarter  <Box component={'span'} sx={{color:"#FD7A25"}}>Workforce Systems</Box></Typography>
                                <Typography sx={{color:'#071B52', fontSize:17}}>Kitkat builds powerful HRM software, biometric attendance <br /> and payroll systems that automate HR operations, improve <br /> productivity and ensure compliance.</Typography>
                            </Box>
                                        ...
                                        return (
                                            <Grid size={{xs:item.xs,sm:item.sm,lg:3}} sx={{display:"flex",
                                                ...
                                                <Box sx={{width:{},display:"flex",gap:1,alignItems:"center",px:{sm:1.5,md:0}, flexDirection:'column'}}>
                                                    ...
                                                    <Typography sx={{fontSize:{xs:"0.55rem",sm:"0.9rem",md:"0.95rem", width:120, color:'#071B52',textAlign:'center', fontWeight:550}}}>{item.text}</Typography>
                                                </Box>
                                            </Grid>
                                        )
                                    })
                            ...
                            <Box sx={{display:"flex",gap:3}}>
                                <CommonButton endIcon={<EastOutlinedIcon/>} variant="contained" sx={{fontSize:"0.95rem", bgcolor:'#FD7A25', fontWeight:550}}>Book a Free Consultation</CommonButton>
                ...
                <Grid size={{ xs: 12, md: 6.5 }}>
                    <Box sx={{position: "relative",width: "100%",height: '100%',overflow: "hidden", }}>
                        <Box component="img" src={hrmheroimg} sx={{width: "100%",height: 500,objectFit: "fill",display: "block", }}/>
