                    ...
                    <Box sx={{height:"100%",display:"flex",flexDirection:"column"}}>
                        <Box sx={{display:"flex",flexDirection:"column",justifyContent:"space-evenly",flexGrow:1,p:{xs:2,lg:1},pl:{xs:2,lg:6},gap:{xs:2,lg:0}}}>
                            <Box sx={{display:"flex",flexDirection:"column",gap:2}}>
                                <Typography component={'h1'} variant="h3" sx={{fontSize:{lg:"2.5rem"},fontWeight:"600", color:'#071B52', }}>Website Design and Web Development Company In Coimbatore</Typography>
                                <Typography sx={{color:'#071B52' }} >We design beautifu,responsive websites and build powerful,SEO-ready solutions that help your business grow online.</Typography>
                            </Box>
                            ...
                            <Box sx={{display:"flex",gap:3, mt:0}}>
                                <CommonButton endIcon={<EastOutlinedIcon/>} sx={{fontSize:"0.9rem", bgcolor:'#1a73e8', color:'white', fontWeight:550, width:'300px'}}>Request a Free Consultation</CommonButton>
                                <CommonButton startIcon={<ImportantDevicesOutlinedIcon/>}  sx={{fontSize:"0.9rem", border:'2px solid #1a73e8', color:'#1a73e8' , width:'200px', fontWeight:'bold' }}>View Our Work</CommonButton>
                            </Box>
                        </Box>
                    </Box>
                </Grid>
