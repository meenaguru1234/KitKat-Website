...
import { contactauth } from '../../components/Axios/authaxios';
...
const handleSubmit = async (e) => {
  try {
    ...
    const res = await contactauth.post("http://localhost:4000/postContact", formData);
    console.log("successfully applied", res.data);
  ...
  onChange={(e) => {
    ...
    setEmailError(""); // clear error when user retypes
  }}
