...
const Faq = () => {
  ...
  const leftarray = [
        {
            id:1,
            ques:"How long does it take to develop a web application?",
         ...
         {
            id:2,
            ques:"What technologies do you use for web application development?",
            ans: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse malesuada lacus ex, sit amet blandit leo lobortis eget."
        },
    ...
    const rightarray = [
              {
            id:4,
            ques:"How much does it cost to develop a web application?",
            ans: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse malesuada lacus ex, sit amet blandit leo lobortis eget."
        },
         {
            id:5,
            ques:"will my web application be mobile-friendly?",
            ans: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse malesuada lacus ex, sit amet blandit leo lobortis eget."
        },
         {
            id:6,
            ques:"Can you integrate third-party services or APIs?",
            ans: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse malesuada lacus ex, sit amet blandit leo lobortis eget."
        },
    ]
    ...
    return (
        <Box sx={{display:"flex",flexDirection:"column",gap:2,mt:4}}>
            <Box sx={{display:"flex",flexDirection:"column",alignItems:"center"}}>
                <Typography component={'h1'} variant='h5' sx={{fontWeight:600, color:'#0B2E6B'}}>Freaquently Asked Questions</Typography>
