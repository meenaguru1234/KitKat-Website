  ...
  const leftarray = [
        {
         ...
         {
            id:3,
            ques: "How long does it take to see results from social media marketing?",
            ans: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse malesuada lacus ex, sit amet blandit leo lobortis eget."
        },
        
        {
            id:4,
            ques:"Do you create content as well as run ads?",
            ans: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse malesuada lacus ex, sit amet blandit leo lobortis eget."
        },
    ...
    const rightarray = [
          {
            id:5,
            ques:"How much do your social media marketing services cost?",
            ans: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse malesuada lacus ex, sit amet blandit leo lobortis eget."
        },
         {
            id:6,
            ques:"Will I get a dedicated account manager?",
            ans: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse malesuada lacus ex, sit amet blandit leo lobortis eget."
        },
         {
            id:7,
            ques:"How do you measure the success of campaigns?",
            ans: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse malesuada lacus ex, sit amet blandit leo lobortis eget."
        },
         {
            id:8,
            ques:"Can you help with influencer marketing?",
            ans: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse malesuada lacus ex, sit amet blandit leo lobortis eget."
        },
    ]
    ...
    return (
        <Box sx={{display:"flex",flexDirection:"column",gap:2,mt:4}}>
            ...
            display:'flex', flexDirection:'row', flexWrap:'nowrap', height:'100%', width:1500} }>
