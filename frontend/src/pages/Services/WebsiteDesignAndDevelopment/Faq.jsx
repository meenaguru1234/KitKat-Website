...
const Faq = () => {
    ...
    const leftarray = [
        {
            id:1,
            ques:"How long does it take to build to website?",
         ...
         {
            id:2,
            ques:"What factors affect the website design cost?",
            ans: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse malesuada lacus ex, sit amet blandit leo lobortis eget."
        },
    ...
    const rightarray = [
          {
           ...
           {
            id:5,
            ques:"Do you provide domain and hosting?",
            ans: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse malesuada lacus ex, sit amet blandit leo lobortis eget."
        },
           {
            id:6,
            ques:"Do you provide website maintenance services?",
            ans: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse malesuada lacus ex, sit amet blandit leo lobortis eget."
        },
    ...
    return (
        ...
        <Grid containerspacing={2} sx={{display:'flex',justifyContent:'center' , px:2,gap:2,
            display:'flex', flexDirection:{xs:'coloumn', md:'row'}, flexWrap:'nowrap', height:'100%', width:{xs:700, md:1500}} }>
