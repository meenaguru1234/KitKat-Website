...
const FaqDigi = () => {
  ...
  const leftarray = [
        {
            id:1,
            ques:"What is digital marketing?    ",
         ...
         {
            id:2,
            ques:"Who can join this digital marketing course?",
            ans: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse malesuada lacus ex, sit amet blandit leo lobortis eget."
        },
         {
            id:3,
    ...
    const rightarray =  [
         ...
         {
            id:6,
            ques:"Is this course available online?",
            ans: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse malesuada lacus ex, sit amet blandit leo lobortis eget."
        },
            {
            id:7,
            ques:"Do I need any prior knowledge?",
            ans: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse malesuada lacus ex, sit amet blandit leo lobortis eget."
        },
            {
            id:8,
    ...
    return (
        <Box sx={{display:"flex",flexDirection:"column",gap:2, mb:2}}>
            <Box sx={{display:"flex",flexDirection:"column",alignItems:"center"}}>
                <Typography component={'h2'} variant='h5' sx={{fontWeight:600, color:'#0B2E6B', textTransform:'uppercase', fontSize:'24px'}}>Freaquently Asked Questions</Typography>
                 </Box>
