            ...
            <Grid container spacing={1}>
                ...
                <Grid size={{xs:12,lg:8}} >
                    ...
                    <Grid container sx={{height:"100%", border:'1px solid #c8c6c6', p:2, borderRadius:2}}>
                        ...
                        <Box>
                            <Typography sx={{fontSize:'1.4rem', color:'#071B52', textTransform:'uppercase', fontWeight:800,  }}>Full Stack Developer Course Syllabus (Mern Stack) </Typography>
                        </Box>

                     <SyllabusTable/> 

                     <Typography sx={{fontSize:'0.9rem', color:'#071B52',}}>Note: Syllabus may vary slightly for Java Full Stack and Python Full Stack tracks.</Typography>  
