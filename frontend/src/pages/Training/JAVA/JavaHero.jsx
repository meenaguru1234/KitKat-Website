  ...
  return (
        <Box sx={{position:"relative", }}>
            <Grid container sx={{           }}>
                        ...
                        <Box sx={{display:"flex",flexDirection:"column",justifyContent:"space-evenly",flexGrow:1,p:{xs:2,lg:1},pl:{xs:2,lg:6},gap:{xs:2,lg:0}}}>
                            <Box sx={{display:"flex",flexDirection:"column",gap:2}}>
                                <Typography component={'h1'} variant="h3" sx={{fontSize:{lg:"2.9rem"},fontWeight:"700", color:'white', }}>
                                  Java Training <Box component='span' sx={{color:'#f6f605'}}> In Coimbatore</Box></Typography>
                                <Typography sx={{color:'white', fontSize:'2rem' }} >Learn Java. Build Projects. Get Placed.</Typography>
                           <Typography sx={{color:'#d9d4d4', lineHeight:'1.8rem', fontSize:18 }} >KitKat Software Technologies provides industry-focused Java training <br />
                           that turns beginners into confident , job-ready developers with real-world<br /> skills and 100% placement support.</Typography>
                            </Box>
                ...
                <Grid size={{ xs: 12, md: 6 }}>
                    <Box sx={{position: "relative",width: "auto",height: "auto",overflow: "hidden", }}>
                        <Box component="img" src={mernheroimg} sx={{width: "100%",height: "50%",objectFit: "cover",display: "block", }}/>
