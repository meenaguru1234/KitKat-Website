...
const WhyAi = () => {
   ...
   const service = [
        { 
            ...
            bgcolor: "#1976d2", 
            color: "#1976d2", 
            desc: "Learn from AI professionals with real-world experience." 
        },
        { 
        ...
        { 
            ...
            bgcolor: "#8e44ad" , 
            color: "#8e44ad" , 
            desc:"Curriculum designed as per latest industry requirements."
        },
        { 
  ...
  <Grid container spacing={3}>
            ...
            <Grid size={{ xs: 12 }} sx={{ textAlign: "center" , maxWidth:'100%', textAlign:'center'}}>
                ...
                textAlign:'center' }}>Why KitKat is the  <Box component='span' sx={{color:'#e1210bec'}}> Best AI Institute</Box> in Coimbatore?</Typography>
            </Grid>
