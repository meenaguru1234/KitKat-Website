...
const StudentSayDataSci = () => {

  const testimonials = [
    {
     
      quote: "The best data science course in Coimbatore! Hands-on projects and expert guidance helped me land my dream job as a Data Analyst.",
      avatar: avatar1,
      name: "Karthik S.",
    ...
    },
    {
      ...
      quote:  "Excellent training with real datasets and practical approach. The mentors are very supportive throughout the course.",
      avatar: avatar2,
      name: "Priya Dharshini",
      designation: "Data Scientist, Zoho"
    },
    {
     
      quote: "I joined with zero coding knowledge. Now I can build ML models confidently. Thank you Kitkat!",
      avatar: avatar3,
      name: "Harish Kumar",
      designation: "ML Engineer, Wipro",
    },
...
export default StudentSayDataSci