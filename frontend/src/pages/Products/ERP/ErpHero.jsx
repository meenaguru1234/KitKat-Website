...
import erpheroimg from "../../../assets/Images/product/erp/crpheroimg.jpg";
...
const ErpHero = () => {
  ...
  const trainingArray = [
    {
      icon: DoneIcon,
     text: "Integrated Business Processes",
      color: "#055DD8",
      borderRight:true,
      jsx:"end",
      jss:"end",
            ...
            <Grid container>
                        ...
                        <Box sx={{display:"flex",flexDirection:"column",justifyContent:"space-around",flexGrow:1,p:{xs:2,lg:1},pl:{xs:2,lg:6},gap:{xs:2,lg:0}}}>
                            <Box sx={{display:"flex",flexDirection:"column",gap:2}}>
                                <Typography component={'h1'} variant="h3" sx={{fontSize:{lg:"2.8rem"},fontWeight:"600", color:'#071B52', }}>
                                  ERP Software Development Service <br /> in <Box component={'span'} sx={{color:'#fc8804'}}>Coimbatore</Box></Typography>
                                <Typography sx={{color:'#041b59' , fontSize:17.5}} >
                                    Custom ERP solutions that streamline your business <br /> processes, integrate departments and drive growth <br /> with real-time insights.</Typography>
                            </Box>
                            ...
                            <Box sx={{display:"flex",gap:3, mt:0}}>
                                <CommonButton endIcon={<EastOutlinedIcon/>}  sx={{fontSize:"0.9rem", bgcolor:'#fc8804', color:'white', fontWeight:550, width:'320px'}}>Get a Free ERP Consultation</CommonButton>
                ...
                <Grid size={{ xs: 12, md: 7 }}>
                    <Box sx={{position: "relative",width: "auto",height: 500}}>
                        <Box component="img" src={erpheroimg} sx={{objectFit: "fill",width: "100%",height: "100%", display:'block', overflow:'hidden',
                            }}/>
