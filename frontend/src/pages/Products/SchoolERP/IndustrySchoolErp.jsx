...
const shelfplatform = [
  ...
  const industryweserve = [
    {
      ...
      title: "Schools (CBSE, ICSE, State Board)",
      color:'#1a73e8'
    },
    {
      icon: CorporateFareIcon,
      title: "Matriculation Schools",
      color:'#1a73e8'
    },
    {
    ...
    },
    {
      ...
      title: "Multi-Branch School Chains",
      color:'#e89c1a'
    },  
     {
      icon: VpnLockIcon,
      ...
      title: "Trusts & Educational Societies",
      color:'#e81a96'
    },
    ,
  ];
  ...
  return (
    <Box sx={{ py: { xs: 2, md: 0 }, px: { xs: 2, md: 5 } }}>
...
>
  ...
  >
                Custom ERP vs Off-the-Shelf Solutions</Typography>
                </Box>
              ...
              return (
                <Grid size={{ xs: 6, sm: 6 }} key={index} >
                  <Box sx={{ textAlign: "center", display: "flex", flexDirection: "row", alignItems: "center", gap: 2,  }}>
                    ...
                    <Icon sx={{ fontSize: { xs: "1.8rem", md: "2.2rem" }, color: '#071B52', textAlign:'center', p:'auto' }} />
                     </Box>                    
                     <Box>
...
export default IndustrySchoolErp;
