  ...
  const servicesArray = [
    {
      ...
      text: "Designed around how Indian schools operate in reality.",
    },
    {
      icon: CardGiftcardOutlinedIcon,
      color: "#1a73e8",
      title: "Easy to Use Interface",
      text: "Simple, clean and easy for staff, teachers, students and parents.",
    },
    {
    ...
    },
    {
      ...
      text: "Access anytime, anywhere on any device.",
    },
    {
      icon: BarChartOutlinedIcon,
      color: "#1a8d8f",
      title: "Real-time Reports",
      text: "Instant dashboards for better decisions and planning.",
    },
    {
      icon: HeadsetMicOutlinedIcon,
      color: "#d928b9",
      title: "Local Support You Can Count On",
      text: "Dedicated support team in Coimbatore and across India.",
    },
  ...
  return (
    <Box sx={{ py: { xs: 2, md: 3}, px: { xs: 2, md: 6 } }}>
      ...
      <Box sx={{ textAlign: "center", mb: { xs: 4, md: 2 } }}>
        ...
        >
        Why Choose Kitkat for School ERP Software?
        </Typography>
