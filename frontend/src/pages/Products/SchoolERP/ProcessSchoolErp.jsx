      ...
      const processSteps = [
            {
              ...
              bgcolor:false,
                 ...
                 desc:"We understand your processes and goals."
            },
            {
                number:'2',
              ...
              bgcolor:false,
                  ...
                  desc:"We create a detailed plan & roadmap."
            },
            {          
              number:'3',
              ...
              bgcolor:false,
                ...
                desc:"We build and integrate your ERP system."
            },
            {         
              number:'4',
            ...
            desc:"Rigorous testing for quality & security."
            },
             {
          number:'5',
          ...
          bgcolor:true,
          title: "Deployment",
          desc: "Smooth go-live with data migration."
        },
            {
              number:'6',
          ...
          bgcolor:true,
          title: "Support",
          desc: "Ongoing training & continuous support."
        },
 ...
 <Grid container sx={{ mx:'auto', width:1300}}>
  ...
  <Grid size={{xs:12,sm:12,}} sx={{border:"1px solid #E5E7EB",borderRadius:5, }}>
                   ...
                   <Box sx={{justifyContent:'left',mb:3 }}>
                            <Typography sx={{fontSize:'1.5rem', fontWeight:600, color:'#08044f'}}>Our School ERP Development Process</Typography>
                ...
                <Box key={index} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                    ...
                    <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', mb:2 }}>
                      <Typography sx={{ fontWeight:600, color: '#041649', fontSize: "1rem" , textAlign:'center'}}>
                        ...
                        <Typography sx={{ fontWeight: 500, color: '#041649', fontSize: "0.85rem" , textAlign:'center', width:180, }}>
                            {step.desc}
                        </Typography>
                    </Box>
...
export default ProcessSchoolErp