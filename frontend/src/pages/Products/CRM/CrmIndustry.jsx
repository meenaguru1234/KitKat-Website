...
const shelfplatform = [
  ...
  const industryweserve = [
    ...
    },
    {
      ...
      title: "Manufacturing & B2B Distribution",
      color:'#e89c1a'
    },  
     {
...
>
  ...
  >
                Custom CRM Software vs Off-the-Shelf Platforms</Typography>
                </Box>
                ...
                <Grid size={{ xs: 6, sm: 6 }} key={index} >
                  <Box sx={{ textAlign: "center", display: "flex", flexDirection: "row", alignItems: "center", gap: 2,  }}>
                    ...
                    <Icon sx={{ fontSize: { xs: "1.8rem", md: "2.7rem" }, color: item.color, textAlign:'center', p:'auto' }} />
                     ...
                     <Box>
                        <Typography sx={{ fontWeight: 700, fontSize: { xs: "0.7rem", md: "1.2rem" }, color: "#071B52" , width:200,textAlign:'left'}}>
                      {item.title}
                    </Typography>
                      </Box>
                  </Box>
