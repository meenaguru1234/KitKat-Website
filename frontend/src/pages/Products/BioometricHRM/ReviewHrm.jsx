...
import Logo1 from "../../../assets/Images/product/hrm/kpr.jpg"
import Logo2 from "../../../assets/Images/product/hrm/aroma.png"
import Logo3 from "../../../assets/Images/product/hrm/ganga.jpg"
import Logo4 from "../../../assets/Images/product/hrm/saravanastores.jpg"
import Logo5 from "../../../assets/Images/product/hrm/sakthi.png"
...
const reviewData = [
        {
            id: 1,
            name: "S. Ramesh,",
            company: " HR Manager, KPR Mills",
            review:
            "Kitkat's HRM software has reduced our payroll processing time by 60% and eliminated manual attendance errors. Excellent support team!",
            image: Vijay,
        },
                    ...
                    <Grid container spacing={2} sx={{px:5,height:"50%",mt:4}}>
                        {
                            logoArray.map((item,index) => {
                                return (
                                    <Grid size={4} key={index} sx={{display:"flex",alignItems:"center",height:"60%",border:"1px solid #EBF0F3",borderRadius:3,p:1}}>
