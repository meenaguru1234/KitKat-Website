...
import matriheroimg from "../../../assets/Images/product/matrimony/matriheroimg.png";
...
const MatriHero = () => {
  ...
  const trainingArray = [
    {
      icon: DoneIcon,
     text: "Custom Matrimony Solutions",
      color: "#055DD8",
      borderRight:true,
      jsx:"end",
      jss:"end",
    ...
    {
      icon: DoneIcon,
      text: "Fast Launch & Ongoing Support",
      color: "#FE8240",
      borderRight:false,
      jsx:"end",
      jss:"center",
            ...
            <Grid container>
                    ...
                    <Box sx={{height:"100%",display:"flex",flexDirection:"column", }}>
                        <Box sx={{display:"flex",flexDirection:"column",justifyContent:"space-around",flexGrow:1,p:{xs:2,lg:1},pl:{xs:2,lg:6},gap:{xs:2,lg:0}}}>
                            <Box sx={{display:"flex",flexDirection:"column",gap:2}}>
                              ...
                              Matrimony Website Development Company<br /> in <Box component={'span'} sx={{color:'#b40c52'}}>Coimbatore</Box></Typography>
                                <Typography sx={{color:'#041b59' , fontSize:17.5}} >
                                   We build secure, feature-rich and mobile-friendly matrimony <br />
                                    websites that connect people and create meaningful <br />
                                    relationships. Custom solutions for communities, marriage <br /> bureaus and entrepreneurs across India.</Typography>
                            </Box>
                                        ...
                                        return (
                                            <Grid size={{xs:item.xs,lg:6}} sx={{display:"flex"}}>
                                                <Box sx={{width:{},display:"flex",gap:1,alignItems:"center",px:{sm:1.5,md:0}}}>
                                                    <Icon sx={{fontSize:{xs:"1rem",sm:"1.5rem",lg:"1.5rem"}, color:'#b40c52'}}/>
                            ...
                            <Box sx={{display:"flex",gap:3, mt:0}}>
                                <CommonButton endIcon={<EastOutlinedIcon/>}  sx={{fontSize:"0.9rem", bgcolor:'#b40c52', color:'white', fontWeight:550, width:'320px'}}>Book a Free Consultation</CommonButton>
                ...
                <Grid size={{ xs: 12, md: 7 }}>
                    <Box sx={{position: "relative",width: "auto",height: 500}}>
                        <Box component="img" src={matriheroimg} sx={{objectFit: "fill",width: "100%",height: "100%", display:'block', overflow:'hidden',
                            }}/>
